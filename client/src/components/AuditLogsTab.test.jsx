  ...
  const mockLogs = [
    {
      ...
      // AuditLog's server-side toJSON transform (see server/src/models/AuditLog.js)
      // flattens actor down to a plain name string, with role as a separate
      // top-level field — not a nested { name, role } object.
      actor: 'Admin User',
      role: 'HR Director',
