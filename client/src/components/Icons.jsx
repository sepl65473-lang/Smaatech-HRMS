...
export const IconWorkforce = (p) => (
  <svg {...base} {...p}><circle cx="9" cy="7" r="3.5" /><path d="M2.5 20v-1a6.5 6.5 0 0 1 13 0v1" /><path d="M16.5 4.5a3.5 3.5 0 0 1 0 6.8" /><path d="M20 20v-1a6 6 0 0 0-4-5.66" /></svg>
);
export const IconPresent = (p) => (
  <svg {...base} {...p}><circle cx="12" cy="12" r="9" /><path d="m8.5 12.5 2.5 2.5 5-5" /></svg>
);
export const IconOnLeave = (p) => (
  <svg {...base} {...p}><rect x="3" y="5" width="18" height="16" rx="2" /><path d="M3 10h18M8 3v4M16 3v4" /><path d="M8.5 15c1-1.2 2.2-1.8 3.5-1.8s2.5.6 3.5 1.8" /></svg>
);
export const IconOpenPositions = (p) => (
  <svg {...base} {...p}><rect x="3" y="8" width="18" height="12" rx="2" /><path d="M8 8V6a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /><path d="M12 12v4M10 14h4" /></svg>
);
