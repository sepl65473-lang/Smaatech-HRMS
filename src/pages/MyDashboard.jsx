  ...
  if (!me) {
    return (
      <div className="page-wrap active">
        <div className="card"><div className="empty">No linked employee record found for this profile.</div></div>
      </div>
    );
  }
          ...
          {todayRow ? (
            <div className="leave-item" style={{ flexDirection: 'column', alignItems: 'stretch', gap: 12 }}>
              ...
              {settings.gpsCheckInEnabled && !todayRow.checkOut && (
                <div style={{
                  background: 'var(--paper-dark, #f8f9fa)',
                  padding: '10px 14px',
                  borderRadius: '8px',
                  fontSize: '13px',
                  ...
                  <div style={{ fontWeight: 600, marginBottom: 6, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <span style={{ fontSize: '11px', color: '#6c757d' }}>(Enabled by Admin)</span>
                  </div>
                  ...
                  {gpsLoading ? (
                    ...
                    gpsStatus.error ? (
                      <div style={{ color: '#dc3545', fontSize: '12px', fontWeight: 500 }}>❌ {gpsStatus.error}</div>
                    ) : (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                        <div style={{ color: gpsStatus.isInside ? '#198754' : '#dc3545', fontWeight: 600, fontSize: '12.5px' }}>
              ...
              <div className="leave-actions" style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 4, alignItems: 'center' }}>
                ...
                {todayRow.checkIn && todayRow.checkOut && (
                  <span className="muted-text" style={{ display: 'flex', alignItems: 'center', gap: 4, color: '#198754', fontWeight: 600 }}>
