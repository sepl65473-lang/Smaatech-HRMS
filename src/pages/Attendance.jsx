...
export default function Attendance() {
  ...
  return (
    <div className="page-wrap active">
      ...
      <>
      <div className="stats">
        <div className="stat"><div className="stat-label">Present</div><div className="stat-value">{counts.present}</div><div className="stat-meta">checked in on time</div></div>
        <div className="stat"><div className="stat-label">Late</div><div className="stat-value">{counts.late}</div><div className="stat-meta">past shift start + grace</div></div>
        <div className="stat"><div className="stat-label">Absent</div><div className="stat-value">{counts.absent}</div><div className="stat-meta">no check-in yet</div></div>
        <div className="stat"><div className="stat-label">On leave</div><div className="stat-value">{counts.leave}</div><div className="stat-meta">approved leave</div></div>
      </div>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 18, padding: '10px 0' }}>
          ...
          <div style={{
            fontSize: '12px',
            color: '#666',
            background: 'var(--paper-dark, #f5f5f5)',
            padding: '6px 12px',
            borderRadius: '6px',
