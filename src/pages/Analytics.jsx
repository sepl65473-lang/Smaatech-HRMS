...
export default function Analytics() {
  ...
  return (
    <div className="page-wrap active">
      ...
      <div className="stats">
        <div className="stat"><div className="stat-label">Headcount</div><div className="stat-value">{scopedEmployees.length}</div><div className="stat-meta">{dept} workforce</div></div>
        <div className="stat"><div className="stat-label">Attendance</div><div className="stat-value">{attendanceRate}%</div><div className="stat-meta">{present} present today</div></div>
        <div className="stat"><div className="stat-label">Avg rating</div><div className="stat-value">{avgRating}</div><div className="stat-meta">performance score</div></div>
        <div className="stat"><div className="stat-label">Net payout</div><div className="stat-value mono" style={{ fontSize: 22 }}>{formatINR(netPayout)}</div><div className="stat-meta">{openRoles} open roles overall</div></div>
      </div>
