...
export default function Payroll() {
  ...
  return (
    <div className="page-wrap active">
      <div className="stats">
        <div className="stat"><div className="stat-label">Gross payout</div><div className="stat-value mono" style={{ fontSize: 22 }}>{formatINR(totals.gross)}</div><div className="stat-meta">{cyclePayroll.length} employees</div></div>
        <div className="stat"><div className="stat-label">Deductions</div><div className="stat-value mono" style={{ fontSize: 22 }}>{formatINR(totals.ded)}</div><div className="stat-meta">tax + PF + others</div></div>
        <div className="stat"><div className="stat-label">Net payout</div><div className="stat-value mono" style={{ fontSize: 22 }}>{formatINR(totals.net)}</div><div className="stat-meta">to be disbursed</div></div>
        <div className="stat"><div className="stat-label">Pending slips</div><div className="stat-value">{totals.ready}</div><div className="stat-meta">ready to process</div></div>
      </div>
