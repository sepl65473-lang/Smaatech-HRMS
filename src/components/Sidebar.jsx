...
function Item({ to, icon: Icon, label, badge, onNavigate, role }) {
  ...
  return (
    <aside>
      ...
      <div className="nav-section">
        ...
        <Item to="/leave" icon={IconLeave} label="Leave" role={currentUser.role} badge={pendingLeaves.length || null} onNavigate={onNavigate} />
